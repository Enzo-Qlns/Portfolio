...
const projects = [
  {
    name: 'Iut-mark-calculator',
    description:
      "Extension google qui permet d'afficher vos moyennes sur le site IUT de Reims.",
    link: {
      href: 'https://github.com/Enzo-Qlns/Iut-mark-calculator',
  ...
  },
  {
    ...
    description:
      "Developpement du frontend d'un site WEB de E-commerce. API utilisée : PlatziFake Store API",
    link: {
      href: 'https://github.com/Enzo-Qlns/e-commerce-react',
      label: 'Voir sur github',
    },
      ...
      >
        {projects.map((project) => (
          <Card as="li" key={project.name}>
            <div className="relative z-10 flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-gray-200 dark:ring-0">
              <Image
                src={project.logo}
                alt=""
                className="h-8 w-8"
